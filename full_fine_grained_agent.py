...
"""
    ...
    judge_task_prompt = f"""
You are the head of radiology. You have been provided with scorecards for {len(scorecards)} CT slices. 
...
Be very conservative; start with a baseline of 3 and only increase if the evidence is exceptionally strong.
